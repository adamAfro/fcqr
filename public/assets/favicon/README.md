...
Insert the following code in the `head` section of your pages:
    ...
    <link rel="mask-icon" href="/assets/favicon/safari-pinned-tab.svg" color="#d55b5b">
    <link rel="shortcut icon" href="/assets/favicon/favicon.ico">
    <meta name="apple-mobile-web-app-title" content="FCQR">
    <meta name="application-name" content="FCQR">
